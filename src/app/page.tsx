...
export const metadata: Metadata = {
  title: "Pest Patrol | Fast & Reliable Pest Control Services",
  description: "Professional pest control services for residential and commercial properties. Locally owned and operated, fully licensed, and insured.",
  keywords: ["pest control", "pest patrol", "termite control", "rodent removal", "exterminator", "residential pest control", "commercial pest control"],
};
